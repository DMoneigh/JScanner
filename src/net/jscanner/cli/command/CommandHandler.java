package net.jscanner.cli.command;

import java.util.Scanner;
import java.util.regex.Pattern;

import net.jscanner.cli.command.impl.DateCommand;
import net.jscanner.cli.command.impl.FindCommand;
import net.jscanner.cli.command.impl.GuiCommand;
import net.jscanner.cli.command.impl.ListCommand;
import net.jscanner.cli.command.impl.QuitCommand;
import net.jscanner.cli.command.impl.ReadCommand;
import net.jscanner.cli.command.impl.ScanCommand;
...
public class CommandHandler extends Thread {
	...
	private final Command[] commands = new Command[] {
			...
			new ListCommand(), new QuitCommand(), new ReadCommand(this),
			new ScanCommand()
	};
